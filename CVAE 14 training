...
# --- Model architecture ---
TARGET_DIM = 38       # 14 voltages + 14 angles + 10 gen. powers for IEEE 14-Bus System
CONDITION_DIM = 22    # 11 P loads + 11 Q loads for IEEE 14-Bus System
LATENT_DIM = 6
HIDDEN_1 = 128
HIDDEN_2 = 64
...
BATCH_SIZE = 16
LEARNING_RATE = 0.001636
NUM_EPOCHS = 10
BETA = 1.0

# --- Data division into traning, validation and testing groups ---
TRAIN_RATIO = 0.80    # 80% of the generated dataset for traning data
VAL_RATIO = 0.10      # 10% for validation data
