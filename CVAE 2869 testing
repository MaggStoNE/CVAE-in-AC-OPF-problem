...
# System model:
cvae_model = from_mpc(os.path.join(PGLIB_MODELS_DIR, 'pglib_opf_case2869_pegase.m'), f_hz=60)
net = cvae_model
...
if __name__ == "__main__":
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE2869-bus with AC-OPF FLAT-START"):
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE2869-bus with AC-OPF WARM-START"):
        ...
        p_ext_grid = x_pred_raw[0][5738:5739]
        q_ext_grid = x_pred_raw[0][5739:5740]

        p_gen = x_pred_raw[0][5740:6758:2]
        q_gen = x_pred_raw[0][5741:6758:2]
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE2869-bus with DC-OPF"):
