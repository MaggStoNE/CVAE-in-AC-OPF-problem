...
GEN_DATA_FILE_DIR = r"C:\gen_data\57bus_data.csv"
...
# System model:
cvae_model = from_mpc(os.path.join(PGLIB_MODELS_DIR, 'pglib_opf_case57_ieee.m'), f_hz=60)
net = cvae_model
...
class Encoder(nn.Module):
    def __init__(self, target_dim, condition_dim, latent_dim):
        ...
        self.fc_mu = nn.Linear(HIDDEN_3, latent_dim)
        self.fc_logvar = nn.Linear(HIDDEN_3, latent_dim)
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, condition_dim, target_dim):
        ...
        self.fc1 = nn.Linear(latent_dim + condition_dim, HIDDEN_3)
        self.fc2 = nn.Linear(HIDDEN_3, HIDDEN_2)
        self.fc3 = nn.Linear(HIDDEN_2, HIDDEN_1)
        self.fc4 = nn.Linear(HIDDEN_1, target_dim)
...
if __name__ == "__main__":
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE57-bus with AC-OPF FLAT-START"):
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE57-bus with AC-OPF WARM-START"):
        ...
        p_ext_grid = x_pred_raw[0][114:115]
        q_ext_grid = x_pred_raw[0][115:116]

        p_gen = x_pred_raw[0][116:128:2]
        q_gen = x_pred_raw[0][117:128:2]
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE57-bus with DC-OPF"):
