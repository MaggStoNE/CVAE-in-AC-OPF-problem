...
if __name__ == "__main__":
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE30-bus with AC-OPF FLAT-START"):
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE30-bus with AC-OPF WARM-START"):
        ...
        p_ext_grid = x_pred_raw[0][60:61]
        q_ext_grid = x_pred_raw[0][61:62]

        p_gen = x_pred_raw[0][62:72:2]
        q_gen = x_pred_raw[0][63:72:2]
    ...
    for case in tqdm(range(num_test_samples), desc="Testing IEEE30-bus with DC-OPF"):
